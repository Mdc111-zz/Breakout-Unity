...
public class NeighborVerticalDestroyerAnim : Animation
{
    ...
    public NeighborVerticalDestroyerAnim(Vector3 BrickPosition, ObjectManager objectManager)
    {
    ...
    {
        particleInstance.moveParticleUp(particles[0]);
        particleInstance.moveParticleDown(particles[1]);
    }
